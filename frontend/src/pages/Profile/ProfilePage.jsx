            ...
            <form onSubmit={handleUpdateProfile}>
                <div className="p-6 space-y-6">
                    ...
                    <div className="pt-6 border-t border-slate-200">
                        ...
                        <p className="text-sm text-slate-500 mt-1 mb-4">
                            This will be used to pre-fill the "Bill From"
                        ...
                        <div className="space-y-4 ">
                            ...
                            <TextAreaField
                                ...
                                onChange={handleInputChange}
                                placeholder="Unit-4 Market, Bhubaneswar, India"
                            />
                            <InputField
                                label="Phone"
                                name="phone"
                ...
                <div className="px-6 py-4 bg-slate-50 border-t border-slate-200 flex justify-end">
                    <button
                        type="submit"
                        disabled={isUpdating}
                        className="inline-flex items-center justify-center px-4 py-2 h-10 bg-blue-900 hover:bg-blue-800 text-white font-medium text-sm rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disaabled:cursor-not-allowed"
                    >
                        {isUpdating ? (
