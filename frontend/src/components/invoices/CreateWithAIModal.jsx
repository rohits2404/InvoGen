...
export const CreateWithAIModal = ({ isOpen, onClose }) => {
    ...
    const handleGenerate = async () => {
        if (!text.trim()) {
            toast.error(
                "Please Enter or Paste Some Text to Generate an Invoice",
            );
            return;
        }
                ...
                <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative text-left transform transition-all">
                    ...
                    <div className="space-y-4">
                        <p className="text-sm text-slate-600">
                            Paste any text that contains invoice details (like
                            Client Name, Items, Quantity and Price) and the AI
